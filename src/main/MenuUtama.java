...
public class MenuUtama extends javax.swing.JFrame {
    ...
    private void simpanData() throws SQLException{
        try {
            String insertDbQuery = "insert into " + Configure.namaTabelData + " values('" + txtNis.getText() +
                    "', '" + txtNama.getText() + "', '" + boxJurusan.getSelectedItem().toString() +
                    "', '" + txtAlamat.getText() + "', '" + txtNomor.getText() + "')";
            
            Connection connect = DriverManager
                .getConnection(LoginFrame.urlDb, LoginFrame.usernameDb, LoginFrame.passwordDb);
            connect.createStatement().executeUpdate(insertDbQuery);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Input Data Siswa");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(boxJurusan, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtAlamat)
                            .addComponent(txtNomor, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(98, 98, 98))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        LoginFrame viewLf = new LoginFrame();
        viewLf.setVisible(true);
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (txtNis.getText().isEmpty() || 
            ...
            try {
                ...
                JOptionPane.showMessageDialog(rootPane, "Ada yang Error, Cek Console");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        TampilFrame viewTampil = new TampilFrame();
        viewTampil.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        EditFrame viewEdit = new EditFrame();
